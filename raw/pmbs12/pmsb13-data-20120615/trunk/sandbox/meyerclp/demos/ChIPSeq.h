...
/*
	...
	todo -->template
*/
void CountKmer(std::map<String<Iupac>,unsigned int > &seqCounter, Finder<Index<StringSet<String<Dna5> > > > &finder, String<Iupac> &Kmer,Seq &seq,IupacMaps &IMap){
...
void replaceKmer(Seq &seq,String<unsigned int> &replaceString){
...
void DebugMap(Seq &seq,Seq &back,std::map<String<Dna5>,std::vector<int> > &sequencesCounter,std::map<String<Dna5>,std::vector<int> > &backgroundCounter){
...
void DebugMultiMap(std::map<String<Dna5>,std::vector<int> > &sequencesCounter,std::multimap<double,String<Dna5> > &SortedPValue){
...
void exactGeneralizeCount(std::map<String<Iupac>,unsigned int > &seqCounter,std::map<String<Iupac>,unsigned int > &backCounter,Finder<Index<StringSet<String<Dna5> > > > finder,Finder<Index<StringSet<String<Dna5> > > > finderB,Seq &seq, Seq &back,IupacMaps &IMap){
