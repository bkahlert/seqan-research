...
SEQAN_DEFINE_TEST(test_stats_nuc_increments_two_seq_samelength){
    ...
    SEQAN_ASSERT_EQ(stats.scoreCount[0][nucT],0); 
    SEQAN_ASSERT_EQ(stats.scoreCount[5][nucT],0); 
    
    
    SEQAN_ASSERT_EQ(stats.scoreCount[0][nucA],1); 
    SEQAN_ASSERT_EQ(stats.scoreCount[0][nucC],1); 
}
