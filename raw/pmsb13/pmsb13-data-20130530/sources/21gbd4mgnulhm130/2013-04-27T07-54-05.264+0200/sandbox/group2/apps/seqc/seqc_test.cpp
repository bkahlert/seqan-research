...
const Dna5 nucA = (seqan::Dna5)'A';
const Dna5 nucC = (seqan::Dna5)'C';
const Dna5 nucG = (seqan::Dna5)'G';
const Dna5 nucT = (seqan::Dna5)'T';
const Dna5 nucN = (seqan::Dna5)'N';
...
SEQAN_DEFINE_TEST(test_stats_nuc_increments_two_seq_samelength){
    ...
    SEQAN_ASSERT_EQ(stats.nucCount[0][0],0); 
    SEQAN_ASSERT_EQ(stats.nucCount[1]['a'],0);
   
    stats.collectReadStats(id, "CCCAAA", qual);
    stats.collectReadStats(id, "AAACCC", qual);

    SEQAN_ASSERT_EQ(stats.nucCount[0][nucT],0); 
    SEQAN_ASSERT_EQ(stats.nucCount[5][nucT],0); 
    
    
    SEQAN_ASSERT_EQ(stats.nucCount[0][nucA],1); 
    SEQAN_ASSERT_EQ(stats.nucCount[0][nucC],1); 
}
