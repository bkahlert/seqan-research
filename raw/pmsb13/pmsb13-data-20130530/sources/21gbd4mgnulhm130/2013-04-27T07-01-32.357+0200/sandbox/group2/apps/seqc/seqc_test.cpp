...
unsigned nucA = (seqan::Dna5)'A';
unsigned nucC = (seqan::Dna5)'C';
unsigned nucG = (seqan::Dna5)'G';
unsigned nucT = (seqan::Dna5)'T';
unsigned nucN = (seqan::Dna5)'N';
...
SEQAN_DEFINE_TEST(test_stats_nuc_increments_single_seq){
    ...
    SEQAN_ASSERT_EQ(stats.nucCount[1][(Dna5)'A'],0);
