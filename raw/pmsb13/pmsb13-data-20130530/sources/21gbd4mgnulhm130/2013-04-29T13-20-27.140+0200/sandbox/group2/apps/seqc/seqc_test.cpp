...
SEQAN_DEFINE_TEST(test_stats_nuc_increments_two_seq_samelength){
    ...
    SEQAN_ASSERT_EQ(stats.nucCount[0][nucIdxC],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[1][nucIdxA],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[1][nucIdxC],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[2][nucIdxA],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[2][nucIdxC],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[3][nucIdxA],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[3][nucIdxC],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[4][nucIdxA],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[4][nucIdxC],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[5][nucIdxA],2); 
    SEQAN_ASSERT_EQ(stats.nucCount[5][nucIdxC],2); 
