...
void computeScore(seqan::String<char> const & text, seqan::String<char> const & pattern)
{
...
int main()
{
    ...
    seqan::String<int> score = computeScore(seqan::String<char> const & text, seqan::String<char> const & pattern);
