...
int saminput(candidates &save, modifier &options, statisticals &stats, std::stringstream &header)	// impotiert eine SAM-Datei und speichert sie im Format candidates
{	
	candidate tmp;
	medianTree median;
...
/*
int output(std::vector<std::vector<unsigned>> &input,candidates &ref, char *out, std::stringstream &header)
{	
