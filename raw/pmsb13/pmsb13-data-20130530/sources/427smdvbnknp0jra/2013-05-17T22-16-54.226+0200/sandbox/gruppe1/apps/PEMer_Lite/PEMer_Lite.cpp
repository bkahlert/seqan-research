...
int saminput(candidates &save, modifier &options, statisticals &stats, std::vector<char> &header)	// impotiert eine SAM-Datei und speichert sie im Format candidates
{	
	candidate tmp;
	medianTree median;
