...
seqan::ArgumentParser::ParseResult commands(modifier &options, int argc, char const ** argv)
{
	...
	// Optionen hinzufügen
    addOption(parser, seqan::ArgParseOption(".","input-file","Input SAM-file.",seqan::ArgParseArgument::INPUTFILE));
	...
	setMinValue(parser, "max_del_size", "1");
	setDefaultValue(parser,"max_del_size","100000");

	addOption(parser,seqan::ArgParseOption("s","standard_degression", "This value define the standard degression for length of fragments.",seqan::ArgParseArgument::INTEGER, "INT"));
    ...
    addOption(parser, seqan::ArgParseOption("s","Sort", "Select to sort input file."));
