...
<<<<<<< .mine
	findCluster(result,cluster,candidate::insertion,options);
	findCluster(result,cluster,candidate::deletion,options);
=======
	findCluster(result,cluster,candidate::insertion,0.5);
	findCluster(result,cluster,candidate::deletion,0.5);
>>>>>>> .r348
