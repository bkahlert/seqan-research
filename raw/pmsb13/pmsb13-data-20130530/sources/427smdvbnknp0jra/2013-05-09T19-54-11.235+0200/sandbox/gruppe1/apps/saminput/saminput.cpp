...
{
	seqan::ArgumentParser parser("modifiers");
	addArgument(parser,seqan::ArgParseArgument(seqan::ArgParseArgument::INPUTFILE,"FILE"));
	...
	getOptionValue(x, parser, "SD-variable");
	getOptionValue(y, parser, "Del_SD-variable");
	p=isSet(parser, "uppercase");
	...
	char *file = getArgumentValue(text, parser, 0);
