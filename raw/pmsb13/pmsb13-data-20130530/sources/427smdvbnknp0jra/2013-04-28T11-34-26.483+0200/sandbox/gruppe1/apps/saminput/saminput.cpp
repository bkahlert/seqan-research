...
int saminput(seqan::String<seqan::String<char>>& save, seqan::String<char> filee)
{
    // BamStream open input stream
	char file[]="/Informatik/Development/example.sam";
...
int main()
{
	seqan::String<char> file = {"/Informatik/Development/example.sam"};
