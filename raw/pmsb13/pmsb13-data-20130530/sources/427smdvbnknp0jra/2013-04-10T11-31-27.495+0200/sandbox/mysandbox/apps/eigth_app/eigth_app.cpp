...
int main()
{
	...
	addEdge(align,addVertex(),addVertex())

	addEdge(alignG, addVertex(alignG, positionToId(stringSet(alignG),0), 0, 8),addVertex(alignG, positionToId(stringSet(alignG),1), 0, 8));
	
	addEdge(alignG, addVertex(alignG, positionToId(stringSet(alignG),0), 8, 3),addVertex(alignG, positionToId(stringSet(alignG),1), 8, 3));
