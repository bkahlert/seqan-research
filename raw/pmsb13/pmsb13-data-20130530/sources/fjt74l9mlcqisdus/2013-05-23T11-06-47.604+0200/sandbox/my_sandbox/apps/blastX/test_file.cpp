...
SEQAN_DEFINE_TEST(test_my_app_verify_seed_match)
{
	...
	Match_found verify_found;
	int result = verify_seed_match(protein, read, verify_found, begin, end, position_protein, position_read);
...
SEQAN_DEFINE_TEST(test_my_app_verify_all)
{
	...
	Match_found verify_found;
	int result_verify = VERIFY_ALL(seed_found2, distance, trans_proteine, real_trans_reads, verify_found, proteine);
