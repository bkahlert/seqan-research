...
int find_matches(StrSetSA & trans_proteine,StrSetSA & trans_reads,int seed,Match_found seed_found){
	...
	cout << seed_found.position_read << endl << seed_found.begin_read <<endl<<seed_found.end_read<<
	endl <<seed_found.position_protein <<endl << seed_found.begin_protein <<endl<<seed_found.end_protein<<endl;
	return 0;
}
