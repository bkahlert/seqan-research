...
{
	/**@brief make_cluster clustert eine gegebene Scorematrix
	*@param size_alp Gibt an auf wieviel Zeichen das Alphabet reduziert werden soll 
	*@param scoreMatrix Aminosaeure-Scorematrix (z.B. Blosum60, Pam200, etc.)
	*@return Gibt ein reduziertes Alphabet zurueck
	*/
