...
main<- function(){
  ...
  nthree <- vereinigung(two,not_found_blosum80)
  nfour <- vereinigung(three,not_found_pam120)
  nfife <- vereinigung(four,not_found_pam200)
  nsix <- vereinigung(fife,not_found_pam250)
  nseven<- vereinigung(six,not_found_pam40)
  neight <- vereinigung(seven,not_found_vtml200)
