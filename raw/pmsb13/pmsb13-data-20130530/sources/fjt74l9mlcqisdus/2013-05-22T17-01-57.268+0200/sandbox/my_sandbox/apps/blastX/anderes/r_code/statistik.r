...
main<- function(){
  ...
  fprint(length(vergleich(statistik,blosum_30)))
  print(length(vergleich(statistik,blosum_45)))
  print(length(vergleich(statistik,blosum_80)))
  print(length(vergleich(statistik,pam120)))
  print(length(vergleich(statistik,pam200)))
  print(length(vergleich(statistik,pam250)))
  print(length(vergleich(statistik,pam40)))
  print(length(vergleich(statistik,Vtml200)))
}
main()