...
int main(int argc, char const ** argv){
	...
	/*StringSet<String<AminoAcid> > alphabet = GET_ALPHABET(comVal.size_alp, comVal.numb_alp);
	...
	*/
	...
	if (FIND_MATCHES_FOR_ALL(Reads,ReadID,Proteine,ProteinID,comVal.seed,comVal.hamming_distance,forceAlphabet)==1) return 1;
