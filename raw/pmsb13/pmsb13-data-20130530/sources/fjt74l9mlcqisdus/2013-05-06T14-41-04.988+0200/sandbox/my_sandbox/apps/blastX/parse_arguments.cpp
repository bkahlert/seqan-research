...
int check_values(Variable & comVal,StringSet<String<Dna>> & Reads){
	...
	if (comVal.size_alp<2 || comVal.size_alp>20){
		cerr << "SIZE_ALPHABET MUST BE BETWEEN 2-20 " <<endl;
		return 1;
	}
	...
	if (comVal.hamming_distance>0 && comVal.hamming_distance>=-comVal.seed){
		cerr << "DISTANCE MUST BE BETWEEN -SEED AND 0 "<<endl;
		return 1;
	}
...
void DEFAULT_VALUES(Variable & comVal){
	...
	*/
	comVal.fasta_file = "/home/marjan/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/proteindatabase.fa";
	comVal.fastq_file = "/home/marjan/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/reads.fq";
	comVal.seed = 15; 
	comVal.size_alp = 5;
	comVal.numb_alp = 1;
