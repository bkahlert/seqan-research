...
SEQAN_DEFINE_TEST(test_my_app_append_to_match_found)
{
	...
	SEQAN_ASSERT_EQ(test.position_read[0],1);
	SEQAN_ASSERT_EQ(test.begin_read[0],1);
	SEQAN_ASSERT_EQ(test.end_read[0],4);
	SEQAN_ASSERT_EQ(test.position_protein[0],1);
	SEQAN_ASSERT_EQ(test.begin_protein[0],10);
	SEQAN_ASSERT_EQ(test.end_protein[0],13);
...
SEQAN_DEFINE_TEST(test_my_app_find_matches)
{
	...
	SEQAN_ASSERT_EQ(result,0);
	SEQAN_ASSERT_EQ(test0.position_read[0],0);
	SEQAN_ASSERT_EQ(test0.begin_read[0],0);
	SEQAN_ASSERT_EQ(test0.end_read[0],3);
	SEQAN_ASSERT_EQ(test0.position_protein[0],0);
	SEQAN_ASSERT_EQ(test0.begin_protein[0],4);
	SEQAN_ASSERT_EQ(test0.end_protein[0],7);
	...
	SEQAN_ASSERT_EQ(test.position_protein[0],1);
	SEQAN_ASSERT_EQ(test.begin_protein[0],5);
	SEQAN_ASSERT_EQ(test.end_protein[0],8);
...
SEQAN_DEFINE_TEST(test_my_app_append_to_match_found2)
{
	...
	SEQAN_ASSERT_EQ(verify_found.position_protein[0],8);
	SEQAN_ASSERT_EQ(verify_found.begin_protein[0],4);
	SEQAN_ASSERT_EQ(verify_found.end_protein[0],7);
	SEQAN_ASSERT_EQ(verify_found.position_read[0],9);
...
SEQAN_DEFINE_TEST(test_my_app_verify_all)
{
	...
	for(unsigned i = 0; i < length(verify_found.position_read); ++i)cout << verify_found.position_read[i]<<"\t";	
	cout <<endl;
	for(unsigned i = 0; i < length(verify_found.position_protein); ++i)cout << verify_found.position_protein[i]<<"\t";
	cout <<endl;
	for(unsigned i = 0; i < length(verify_found.begin_protein); ++i)cout << verify_found.begin_protein[i]<<"\t";
	cout <<endl;
	for(unsigned i = 0; i < length(verify_found.end_protein); ++i)cout << verify_found.end_protein[i]<<"\t";
	cout <<endl;
	for(unsigned i = 0; i < length(verify_found.score); ++i)cout << verify_found.score[i]<<"\t";
	cout << endl;
