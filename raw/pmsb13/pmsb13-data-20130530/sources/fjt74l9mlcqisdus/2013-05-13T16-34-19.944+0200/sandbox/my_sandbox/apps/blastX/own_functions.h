...
// OUTPUT.CPP ------------------------------------------------------------------------------------
void write_to_file(Match_found & seed_found, StringSet<String<char> > & proteinID, StringSet<String<char> > & readID,String<unsigned int> numb_alp);
void write_to_file(Match_found & verify_found, StringSet<String<char> > & proteinID, StringSet<String<char> > & readID,StringSet<String<Dna> > & reads,String<unsigned int> numb_alp);
// OUTPUT.CPP ------------------------------------------------------------------------------------
