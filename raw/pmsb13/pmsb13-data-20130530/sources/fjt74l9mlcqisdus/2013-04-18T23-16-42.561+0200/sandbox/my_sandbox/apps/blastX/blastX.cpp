...
int getData(String<char> & file,StringSet<String<Tchar>> & Sequence,StringSet<String<char>> & ID){
	...
	readBatch(ID, Sequence, seqStream);
	return 0;
}
...
int main(int argc, char const ** argv){
	...
	getData(comVal.fastq_file,Reads,ReadID);
