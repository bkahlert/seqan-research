...
main<- function(){
  ...
  statistik <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/statistik.txt")
  blosum_30 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchBlosum30.txt")
  blosum_45 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchBlosum45.txt")
  blosum_80 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchBlosum80.txt")
  pam120 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchPam120.txt")
  pam200 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchPam200.txt")
  pam250 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchPam250.txt")
  pam40 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchPam40.txt")
  Vtml200 <- loadtable("D:/seqan_dev/Development/seqan-trunk/sandbox/my_sandbox/apps/blastX/anderes/r_code/data/k0/matchVtml200.txt")
