...
int PARSE_ARGUMENTS(int argc,char const ** argv,Variable & comVal){
    ...
    addOption(parser, ArgParseOption("d", "DATABASE", "PATH OF THE TARGET DATABASE FASTA FILE",
        ArgParseArgument::STRING, "STRING"));

	addOption(parser, ArgParseOption("r", "READS", "PATH OF THE TARGET READ FASTQ FILE",
        ArgParseArgument::STRING, "STRING"));

	addOption(parser, ArgParseOption("s", "SEED", "SIZE OF THE PIECES FROM THE QGRAM INDEX",
        ArgParseArgument::INTEGER, "INT"));

	addOption(parser, ArgParseOption("a", "SIZE_ALPHABET", "SIZE OF THE REDUCED AMINO ACID ALPHABET",
        ArgParseArgument::INTEGER, "INT"));

	addOption(parser, ArgParseOption("n", "NUMBER_ALPHABET", "NUMBER OF THE DIFFERENT USED ALPHABETS",
        ArgParseArgument::INTEGER, "INT"));
