...
grid(nx=max(table$Base)/3,ny=0,lty=1)
dev.off()
...
legend("topright",legend="Average Quality per read",text.col="red",bg="gray95")
dev.off()
...
legend("topright",legend="%GC",text.col="red",bg="gray95")
dev.off()
...
legend("topright",legend=c("%G","%A","%T","%C","%N"),text.col=c("red","blue","green","black","orange"),bg="gray95")
dev.off()
...
legend("topright",legend=c("GC count per read"),text.col=c("red"),bg="gray95")
dev.off()
...
legend("topright",legend="%N",text.col="red",bg="gray95")
dev.off()
...
legend("topright",legend="Sequence Length",text.col="red",bg="gray95")
dev.off()
...
write(x,file="/home/dkersting/Development/seqan-trunk/sandbox/group2/apps/seqc/output/summary.html")
