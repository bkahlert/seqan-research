...
unsigned i=0;
    ...
    */
std::cout<<"Here"<<*(kmer.kmerCount.begin())<<std::endl;

    for(countIter=kmer.kmerCount.begin();countIter != kmer.kmerCount.begin(); ++countIter,++i){
...
std::cout<<"Am"<<std::endl;
        for(countIter=kmer.kmerCount.begin();countIter != kmer.kmerCount.begin(); ++countIter,++j){
