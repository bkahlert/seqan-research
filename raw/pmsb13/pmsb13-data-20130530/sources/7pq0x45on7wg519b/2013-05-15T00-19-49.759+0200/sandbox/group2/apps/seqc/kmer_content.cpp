...
for(std::map<std::string,int>::const_iterator it = kmerPositions.begin(); it != kmerPositions.end(); ++it) {
{
    std::cout << "coord: " << it->first << "," << it->second<< std::endl;
//for(unsigned ixi = 0; ixi<length(it->second);++ixi)
