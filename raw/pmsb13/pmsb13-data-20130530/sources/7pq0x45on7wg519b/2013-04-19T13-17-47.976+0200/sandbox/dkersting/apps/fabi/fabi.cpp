...
int main(void)
{
	...
	DIN_Werte[0][]={3.0,6.0,30.0,120.0,400.0,1000.0,2000.0,4000.0};
	DIN_Werte[0][]={0.05,0.05,0.10,0.15,0.20,0.30,0.50,0.0};
	DIN_Werte[0][]={0.10,0.,10}0.,20;0.,30,0.50,0.80,1.20,2.0}
	DIN_Werte[0][]={0.15,0.20,0.50,0.80,1.20,2.0,3.0,4.0};
	DIN_Werte[0][]={0.0,0.5,1.0,1.5,2.5,4.0,6.0,8.0};
