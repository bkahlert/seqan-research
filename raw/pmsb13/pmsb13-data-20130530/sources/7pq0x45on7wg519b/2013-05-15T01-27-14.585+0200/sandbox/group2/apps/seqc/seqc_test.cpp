...
SEQAN_DEFINE_TEST(test_kmer_content){
    ...
    SEQAN_ASSERT_EQ(kc.kmerCount["AC"],2); 
    SEQAN_ASSERT_EQ(kc.kmerCount["CC"],2);
    SEQAN_ASSERT_EQ(kc.kmerCount["CA"],2);
    SEQAN_ASSERT_EQ(kc.kmerCount["AT"],1);
    ...
    SEQAN_ASSERT_EQ(kc.kmerCount["AT"],2); 
    SEQAN_ASSERT_EQ(kc.kmerCount["TC"],2);
    SEQAN_ASSERT_EQ(kc.kmerCount["CA"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["AC"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["CG"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["GA"],1);

    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AT"))->second[0],0);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AT"))->second[1],6);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TC"))->second[0],1);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TC"))->second[1],7);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CA"))->second[0],2);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AC"))->second[0],3);
