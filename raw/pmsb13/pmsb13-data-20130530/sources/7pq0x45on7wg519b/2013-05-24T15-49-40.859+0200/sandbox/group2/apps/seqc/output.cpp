...
//std::cout<<countIter->first<<"\t"<<countIter->second<<std::endl;
  //  }
    ...
    */
	...
	unsigned j=0;std::cout<<"1"<<std::endl;
std::cout<<"kmerPositionIter->first\t"<<kmerPositionIter->first<<std::endl;
	...
	//	std::cout<<countIter->first<<"\t"<<countIter->second<<std::endl;
    	...
    	for(int v=0;v<6; ++v){std::cout<<"1"<<std::endl;
		writeIter=(kmerPositionIter->second).find(myvec[v].first);
std::cout<<"3"<<std::endl;
std::cout<<"writeIter->first\t"<<writeIter->first<<std::endl;
std::cout<<"4"<<std::endl;
std::cout<<"writeIter->second\t"<<writeIter->second<<"\n"<<std::endl;
		ss<<"\t"<<writeIter->second;
    	}
	ss<<std::endl;
