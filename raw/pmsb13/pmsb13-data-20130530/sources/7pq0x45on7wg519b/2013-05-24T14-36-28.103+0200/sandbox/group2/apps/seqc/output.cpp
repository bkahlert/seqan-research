...
std::cout<<"Here"<<kmer.kmerCount.size()<<std::endl;
    ...
    for(countIter=kmer.kmerCount.begin();countIter != kmer.kmerCount.end(); ++countIter,++i){
...
std::cout<<"Am"<<std::endl;
        for(countIter=kmer.kmerCount.begin();countIter != kmer.kmerCount.end(); ++countIter,++j){
