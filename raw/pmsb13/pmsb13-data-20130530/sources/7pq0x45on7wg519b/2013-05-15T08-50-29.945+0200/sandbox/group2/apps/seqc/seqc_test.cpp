...
/*      
    SEQAN_ASSERT_EQ(kc.kmerCount["ACC"],2); 
    SEQAN_ASSERT_EQ(kc.kmerCount["CCA"],2);
    SEQAN_ASSERT_EQ(kc.kmerCount["CAT"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["ATA"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["TAC"],1);
*/
    SEQAN_ASSERT_EQ(kc.kmerPositions.find("ACC").find(0),5);
  /*  SEQAN_ASSERT_EQ((kc.kmerPositions.find("ACC"))->second[1],5);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("ACC"))->second[0],0);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CCA"))->second[1],6);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CCA"))->second[0],1);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CAT"))->second[0],2);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("ATA"))->second[0],3);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TAC"))->second[0],4);

    SEQAN_ASSERT_EQ(kc.kmerCount["ATC"],2); 
    SEQAN_ASSERT_EQ(kc.kmerCount["TCA"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["CAC"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["ACG"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["CGA"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["GAT"],1);

    SEQAN_ASSERT_EQ((kc.kmerPositions.find("ATC"))->second[0],0);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("ATC"))->second[1],6);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TCA"))->second[0],1);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CAC"))->second[0],2);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("ACG"))->second[0],3);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CGA"))->second[0],4);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("GAT"))->second[0],5);

    SEQAN_ASSERT_EQ(kc.kmerCount["AC"],3); 
    SEQAN_ASSERT_EQ(kc.kmerCount["CC"],2);
    SEQAN_ASSERT_EQ(kc.kmerCount["CA"],3);
    SEQAN_ASSERT_EQ(kc.kmerCount["AT"],3);
    SEQAN_ASSERT_EQ(kc.kmerCount["TA"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["TC"],2);
    SEQAN_ASSERT_EQ(kc.kmerCount["CG"],1);
    SEQAN_ASSERT_EQ(kc.kmerCount["GA"],1);

    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AC"))->second[0],0);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AC"))->second[1],5);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AC"))->second[2],3);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CC"))->second[0],1);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CC"))->second[1],6);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CA"))->second[0],2);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CA"))->second[1],7);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CA"))->second[2],2);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AT"))->second[0],3);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AT"))->second[1],0);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("AT"))->second[2],6);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TA"))->second[0],4);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TC"))->second[0],1);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("TC"))->second[1],7);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("CG"))->second[0],4);
    SEQAN_ASSERT_EQ((kc.kmerPositions.find("GA"))->second[0],5);
   */
}
