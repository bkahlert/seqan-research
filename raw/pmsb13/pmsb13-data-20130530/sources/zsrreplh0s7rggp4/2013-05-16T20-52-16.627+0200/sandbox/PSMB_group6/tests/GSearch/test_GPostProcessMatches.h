...
SEQAN_DEFINE_TEST(test_GParseMasterID_dummy)
{
 ...
 res=GPostProcessMatches(unsortetResults);
 SEQAN_ASSERT_EQ(unsortetResults[0],13);
 SEQAN_ASSERT_EQ(unsortetResults[1],7);
 SEQAN_ASSERT_EQ(unsortetResults[2],5);
 SEQAN_ASSERT_EQ(unsortetResults[3],3);
 SEQAN_ASSERT_EQ(unsortetResults[4],2);
