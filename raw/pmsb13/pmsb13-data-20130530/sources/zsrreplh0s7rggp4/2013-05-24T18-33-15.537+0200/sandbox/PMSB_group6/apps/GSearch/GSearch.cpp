...
int main(int argc, char const ** argv) {
	...
	addListItem(parser,"GSearch \\fBclustered.rfam.CQ20.fasta queries_rfam.included.fasta Matches_OutPath\\fP -M \\fBmaster.rfam.CQ20.fasta\\fP -f RNA -t 400", "Matches have at least 40% similar 8-grams to the cluster master. Uses a selection of the rfam data where the three queries are included in the database.");
	addListItem(parser,"GSearch \\fBclustered.rfam.CQ20.fasta queries_rfam.included.fasta Matches_OutPath\\fP -f RNA -t 400", "Same as above but clustering is ignored.");
