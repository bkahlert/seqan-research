...
SEQAN_BEGIN_TESTSUITE(test_GCluster)
{
	...
	SEQAN_CALL_TEST(test_GCheckClusterAssign_lengthExact1);
	SEQAN_CALL_TEST(test_GCheckClusterAssign_lengthExact2);
	SEQAN_CALL_TEST(test_GCheckClusterAssign_lengthTooLong);
	SEQAN_CALL_TEST(test_GCheckClusterAssign_lengthTooShort);
	SEQAN_CALL_TEST(test_GCheckClusterAssign_ScoreExact);
	SEQAN_CALL_TEST(test_GCheckClusterAssign_ScoreTooLow);
