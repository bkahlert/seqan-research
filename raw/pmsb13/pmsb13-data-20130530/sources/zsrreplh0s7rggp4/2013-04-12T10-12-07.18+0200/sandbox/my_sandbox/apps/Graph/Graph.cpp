...
int main ()
{
    ...
    TVertexDescriptor arrayedges[]={vert1,vert0,vert0,vert4,vert2,vert1,vert4,vert1,vert5,vert1,vert6,vert2,vert3,vert2,vert2,vert3,vert7,vert3,vert5,vert4,vert6,vert5,vert5,vert6,vert7,vert6,vert7,b
    vert7};
