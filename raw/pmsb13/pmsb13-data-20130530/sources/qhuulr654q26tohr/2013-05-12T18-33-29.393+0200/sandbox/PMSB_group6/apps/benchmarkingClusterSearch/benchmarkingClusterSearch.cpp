...
int main(int argc, char const ** argv) {
	...
	const char * argvGSearch1[] = {"./bin/GSearch",outClustDataBasePath2,outMasterPath2,inQueriesPath,"-m",scoreMode2};
	...
	const char * argvGSearch1[] = {"./bin/GSearch",outClustDataBasePath3,outMasterPath3,inQueriesPath,"-m",scoreMode3};
