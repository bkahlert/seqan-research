...
int main(int argc, char const ** argv) {
	...
	addListItem(parser,"GCluster \\fBpfam.100K.fasta\\fP ClusteredDatabase_OutPath ClusterMasters_OutPath -f AMINOACID -t 80", "dummyExample");
	addListItem(parser,"GCluster \\fBrfam.10K.fasta\\fP ClusteredDatabase_OutPath ClusterMasters_OutPath -f RNA -t 80 -l 0.1", "dummyExample");
