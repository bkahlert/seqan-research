...
int GSearch(String<GMatch<TScore,TSequence> > & matchesCollection, int & dataBaseLength, String<PerformanceSample> & performance,
	...
	bool MASTER_FILE_GIVEN = (toCString(clusterRepresentanten) != toCString("NOFILE") && toCString(clusterRepresentanten) != toCString(""));
	cout << MASTER_FILE_GIVEN << endl;
	cout << clusterRepresentanten << endl;
