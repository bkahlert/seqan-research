...
int main(int argc, char const ** argv) {
	...
	const char * inDataBasePath2 = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/rfam.10K.fasta";
	const char * inQueriesPath2 = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_rfam.short.fasta";
	...
	appendValue(masterSequenceFiles,"../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master.rfam.CQ20.fasta");
	appendValue(masterSequenceFiles,"../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master.rfam.CQ40.fasta");
	appendValue(masterSequenceFiles,"../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master.rfam.CQ150.fasta"); 
	...
	appendValue(matchFiles,"../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches.rfam.CQ20.fasta");
	appendValue(matchFiles,"../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches.rfam.CQ40.fasta");
	appendValue(matchFiles,"../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches.rfam.CQ150.fasta");
	...
	GSearch(matchesSoll, dataBaseLength, performance_uncl, inDataBasePath, "", inQueriesPath, matchFile_uncl, 200, scoreMode);
	...
	for (int i=0; i<length(clustDatabases);++i){
		...
		GSearch(matchesIs, dataBaseLength, performance, clustDatabases[i], masterSequenceFiles[i], inQueriesPath, matchFiles[i], 200, scoreMode);
	...
	GSearch(matchesSoll2, dataBaseLength2, performance_uncl2, inDataBasePath2, "", inQueriesPath2, matchFile_uncl2, 20, scoreMode);
	...
	for (int i=0; i<length(clustDatabases2);++i){
		...
		GSearch(matchesIs2, dataBaseLength2, performance2, clustDatabases2[i], masterSequenceFiles2[i], inQueriesPath2, matchFiles2[i], 20, scoreMode);
		performance2[length(performance2)-1].name=testRunNames[i];
		clSpeed=performance2[length(performance2)-1].getTime();
