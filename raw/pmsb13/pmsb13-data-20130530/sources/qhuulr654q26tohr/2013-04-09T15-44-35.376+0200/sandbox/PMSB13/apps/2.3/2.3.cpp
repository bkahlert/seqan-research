...
int main()
{
    String<String<Dna5> > nucleotideSets;
    String<Dna5> seq1 ="ATATANGCGT";
    String<Dna5> seq2 ="AAGCATGANT";
    String<Dna5> seq3 ="TGAAANTGAC";
    append(nucleotideSets,seq1);
    append(nucleotideSets,seq2);
    append(nucleotideSets,seq3);
    String<Dna5> refSeq="GATGCATGAT";
    String<String<Dna5> > lesser;
    String<String<Dna5> > greater;
