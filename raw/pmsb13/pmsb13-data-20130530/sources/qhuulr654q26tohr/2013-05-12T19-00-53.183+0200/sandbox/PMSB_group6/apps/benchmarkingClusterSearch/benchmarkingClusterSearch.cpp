...
int main(int argc, char const ** argv) {
	...
	const char * inDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/rfam.1M.fasta";
	...
	const char * outClustDataBasePath2 = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/clustered.rfam.LA.fasta";
	...
	const char * outClustDataBasePath3 = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/clustered.rfam.LA.fasta";
	...
	const char * argvGSearch1[] = {"./bin/GSearch",outClustDataBasePath3,outMasterPath3,inQueriesPath,outMatchesPath1,"-m",scoreMode1};
	const char * argvGCluster2[] = {"./bin/GCluster",inDataBasePath,outClustDataBasePath2,outMasterPath2,"-t","100","-m",scoreMode2};
	const char * argvGSearch2[] = {"./bin/GSearch",outClustDataBasePath3,outMasterPath3,inQueriesPath,outMatchesPath2,"-m",scoreMode2};
	const char * argvGCluster3[] = {"./bin/GCluster",inDataBasePath,outClustDataBasePath3,outMasterPath3,"-t","500","-m",scoreMode3};
	const char * argvGSearch3[] = {"./bin/GSearch",outClustDataBasePath3,outMasterPath3,inQueriesPath,outMatchesPath3,"-m",scoreMode3};
	int argcGSearch = 7;
	int argcGCluster = 8;
...
//	GSearch(performance, argcGSearch, argvGSearch1);
//	GSearch(performance, argcGSearch, argvGSearch2);
	GSearch(performance, argcGSearch, argvGSearch3);
