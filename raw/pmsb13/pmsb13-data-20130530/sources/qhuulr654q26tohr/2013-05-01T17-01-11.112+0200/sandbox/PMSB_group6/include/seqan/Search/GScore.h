#ifndef SANDBOX_PMSB_GROUP6_INCLUDE_SEQAN_GScore_H_
#define SANDBOX_PMSB_GROUP6_INCLUDE_SEQAN_GScore_H_
...
int GScore(TScore &score, TRecord &newRecord, TRecord &clusterRecord,
...
#endif  // SANDBOX_PMSB_GROUP6_INCLUDE_SEQAN_GScore_H_