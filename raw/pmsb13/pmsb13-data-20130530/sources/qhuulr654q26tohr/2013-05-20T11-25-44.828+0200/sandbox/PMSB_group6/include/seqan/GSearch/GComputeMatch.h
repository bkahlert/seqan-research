...
int GComputeMatch(String<GMatch<TScore, TSequence> > & matches, GFastaRecord<TSequence> & queryRecord, GFastaRecord<TSequence> & clusterRecord, TScoringScheme & scoringScheme, unsigned QGramSize, TScore threshold, string & scoreMode)
{
	TScore score;
	GScore(score, queryRecord, clusterRecord, scoringScheme, QGramSize, scoreMode);
