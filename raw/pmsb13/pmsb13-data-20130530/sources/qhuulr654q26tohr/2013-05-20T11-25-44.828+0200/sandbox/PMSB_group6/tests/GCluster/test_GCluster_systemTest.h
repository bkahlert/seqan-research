...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_emptyFiles_LAMode)
{
	...
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 4, 0.5, 4, scoreMode);
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_emptyFiles_CQMode)
{
	...
	String<PerformanceSample> performance;
	DnaString sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 800, 0.5, 4, scoreMode);
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_toyFiles_LAMode)
{
	...
	String<PerformanceSample> performance;
	DnaString sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 10, 0.5, 4, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_toyFiles_CQMode)
{
	...
	String<PerformanceSample> performance;
	DnaString sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 850, 0.5, 4, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_rfamFiles_LAMode)
{
	...
	String<PerformanceSample> performance;
	DnaString sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 100, 0.5, 8, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_rfamFiles_CQMode)
{
	...
	String<PerformanceSample> performance;
	DnaString sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 50, 0.5, 8, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}
