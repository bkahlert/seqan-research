...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_emptyFiles_LAMode)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, inMasterReferencePath, inQueriesPath, outMatchesPath,1, 4,scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_emptyFiles_CQMode_unclustered)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, "", inQueriesPath, outMatchesPath,1, 4,scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_toyFiles_CQMode)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, inMasterReferencePath, inQueriesPath, outMatchesPath, 100, 4, scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_toyFiles_CQMode_unclustered)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, "", inQueriesPath, outMatchesPath, 100, 4, scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_rfamFiles_LAMode)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, inMasterReferencePath, inQueriesPath, outMatchesPath, 10, 8, scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_rfamFiles_LAMode_unclustered)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, "", inQueriesPath, outMatchesPath,10, 8, scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_rfamFiles_CQMode)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, inMasterReferencePath, inQueriesPath, outMatchesPath, 50, 8, scoreMode);
...
SEQAN_DEFINE_TEST(test_GSearch_systemTest_speicherzugriffsfehler_0517)
{
	...
	int res = GSearch(matches, dataBaseLength, performance, inClustDataBaseReferencePath, "", inQueriesPath, outMatchesPath,1, 8, scoreMode);
