...
int main(int argc, char const ** argv) {
	...
	const char * inDataBasePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/rfam.10K.fasta";
	...
	for (int i=0; i<length(clustDatabases)-2;++i){
		...
		cout << "matchesSoll:\t" << length(matchesSoll) << endl;
		cout << "matchesIs:\t" << length(matchesIs) << endl;
		cout << "dataBaseLength:\t" << dataBaseLength << endl;
		double sens;
		double spec;
