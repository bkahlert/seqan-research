...
int main(int argc, char const ** argv) {
	...
	const char * inDataBasePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/pfam.1M.fasta";
	...
	appendValue(clusterThresholds, 80);
	...
	appendValue(testRunNames,"clustered GSearch 1");
	appendValue(testRunNames,"clustered GSearch 2");
	appendValue(testRunNames,"clustered GSearch 3");
	...
	for (int i=0; i<length(clustDatabases);++i){
		...
		for (int i=0; i<length(performance);i+=2) {
