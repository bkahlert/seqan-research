...
#include <ginger/GStructs/GScoreStorage.h>
#include <ginger/GStructs/PerformanceSample.h>
#include <ginger/GStructs/MemorySample.h>
#include <ginger/GSearch/GScore.h>
#include <ginger/GSearch/GEvaluateScore.h>
#include <ginger/GSearch/GParseMasterId.h>
#include <ginger/GSearch/GCheckClusterMaster.h>
#include <ginger/GSearch/GComputeMatch.h>
#include <ginger/GSearch/GPostProcessMatches.h>
#include <ginger/GSearch/GWriteMatches.h>
...
int Search(String<PerformanceSample> & performance, int argc, char const ** argv) {
	...
	string scoreMode;
    if (readCommandlineParameters(clusteredDatabase, clusterRepresentanten, queries, outFile, scoreMode, argc, argv))
        return 1;
