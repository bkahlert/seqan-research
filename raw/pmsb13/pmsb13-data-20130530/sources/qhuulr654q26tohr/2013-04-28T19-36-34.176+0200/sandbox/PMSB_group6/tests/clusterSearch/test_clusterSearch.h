...
SEQAN_DEFINE_TEST(test_clusterSearch_emptyFiles)
{
	...
	const char * argv[5] = {"clusterSearch","/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/emptyTest/empty.fasta",outClustDataBasePath,outMasterPath,"-t","4"};
