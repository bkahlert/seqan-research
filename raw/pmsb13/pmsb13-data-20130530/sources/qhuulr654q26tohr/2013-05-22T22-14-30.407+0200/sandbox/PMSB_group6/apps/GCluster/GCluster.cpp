...
int main(int argc, char const ** argv) {
	...
	addListItem(parser,"GCluster \\fBrfam.10K.fasta ClusteredDatabase_OutPath ClusterMasters_OutPath\\fP -f RNA -t 80 -l 0.1", "Cluster members have 8% similar 8-grams and their length varies only by 10% from the cluster master. Uses a selection of the pfam data.");
