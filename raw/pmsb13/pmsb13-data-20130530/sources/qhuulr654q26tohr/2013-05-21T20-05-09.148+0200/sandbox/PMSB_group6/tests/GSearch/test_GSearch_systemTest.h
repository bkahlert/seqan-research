...
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clusteredDatabase_pfam_reference.fasta";
	const char * inMasterReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/master_pfam_reference.fasta";
