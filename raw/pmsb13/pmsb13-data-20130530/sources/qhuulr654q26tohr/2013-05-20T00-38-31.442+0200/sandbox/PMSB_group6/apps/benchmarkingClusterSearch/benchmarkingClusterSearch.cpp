...
int main(int argc, char const ** argv) {
	...
	cout << "starting unclustered Search" << endl;
	...
	for (int i=0; i<length(clustDatabases)-2;++i){
		...
		cout << "starting clustered Search" << endl;
		GSearch(matchesIs, dataBaseLength, performance, clustDatabases[i], masterSequenceFiles[i], inQueriesPath, matchFiles[i], 1, scoreMode);
