...
int main(int argc, char const ** argv) {
	...
	const char * inQueriesPath = "/home/development/seqan-trunk/sandbox/PMSB_group6/data/rfam_thresholdTest_queries.fasta";
	...
	appendValue(clusterThresholds, "250");
	appendValue(clusterThresholds, "350");
	appendValue(clusterThresholds, "450");
