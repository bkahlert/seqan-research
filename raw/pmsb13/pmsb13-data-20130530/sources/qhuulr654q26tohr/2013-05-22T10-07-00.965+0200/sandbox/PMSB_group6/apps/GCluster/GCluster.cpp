...
int main(int argc, char const ** argv) {
	...
	setAppName(parser,"Ginger.GCluster");
	...
	addListItem(parser,"GCluster pfam.100K.fasta \\ClusteredDatabase_OutPath ClusterMasters_OutPath\\fP  -f AMINOACID -t 80", "dummyExample");
	addListItem(parser,"GCluster rfam.10K.fasta \\ClusteredDatabase_OutPath ClusterMasters_OutPath\\fP  -f RNA -t 80 -l 0.1", "dummyExample");
