...
int main(int argc, char const ** argv) {
	...
	const char * inDataBasePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/pfam.10K.fasta";
	...
	GSearch(matchesSoll2, dataBaseLength2, performance_uncl2, inDataBasePath2, "", inQueriesPath2, matchFile_uncl2, 50, scoreMode);
	...
	for (int i=0; i<length(clustDatabases2)-1;++i){
		...
		GSearch(matchesIs2, dataBaseLength2, performance2, clustDatabases2[i], masterSequenceFiles2[i], inQueriesPath2, matchFiles2[i], 50, scoreMode);
