...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_toyFiles_CQMode)
{
	...
	String<PerformanceSample> performance;
	DnaString sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 200, 0.5, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_rfamFiles_LAMode)
{
	...
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 40, 0.5, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}

// rfam_short files & GLOBAL_ALIGNMENT_MODE.
SEQAN_DEFINE_TEST(test_GCluster_systemTest_rfamFiles_GAMode)
{
	const char * inDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/rfam.10K.fasta";
	const char * outClustDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/clusteredDatabase_rfam.fasta";
	const char * outMasterPath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master_rfam.fasta";
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_pfamFiles_LAMode)
{
	const char * inDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/pfam.10K.fasta";
	const char * outClustDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/clusteredDatabase_pfam.fasta";
	const char * outMasterPath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master_pfam.fasta";
	string scoreMode = "LOCAL_ALIGNMENT_MODE";
	
	String<PerformanceSample> performance;
	Peptide sequenceFormatExample;
	int res = GCluster(performance, inDataBasePath, outClustDataBasePath, outMasterPath, sequenceFormatExample, 20, 0.5, scoreMode);
	SEQAN_ASSERT_EQ(res,0);
}

// pfam_short files & GLOBAL_ALIGNMENT_MODE.
SEQAN_DEFINE_TEST(test_GCluster_systemTest_pfamFiles_GAMode)
{
	const char * inDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/pfam.10K.fasta";
	const char * outClustDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/clusteredDatabase_pfam.fasta";
	const char * outMasterPath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master_pfam.fasta";
...
SEQAN_DEFINE_TEST(test_GCluster_systemTest_pfamFiles_CQMode)
{
	const char * inDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/pfam.10K.fasta";
	const char * outClustDataBasePath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/clusteredDatabase_pfam.fasta";
	const char * outMasterPath = "/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/master_pfam.fasta";
