...
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.rfam.CQ20.fasta";
	const char * inMasterReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/master.rfam.CQ20.fasta";
...
// rfam_short files & GLOBAL_ALIGNMENT_MODE.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_rfamFiles_GAMode)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.rfam.CQ20.fasta";
	const char * inMasterReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/master.rfam.CQ20.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_rfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_rfam_GlobalAlignmentMode.txt";
...
// rfam_short files & COMMON_QGRAM_MODE & unclustered.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_rfamFiles_CQMode_unclustered)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.rfam.CQ20.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_rfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_rfam_CommonQgramMode.txt";
...
// pfam_short files & LOCAL_ALIGNMENT_MODE.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_pfamFiles_LAMode)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.pfam.CQ40.fasta";
	const char * inMasterReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/master.pfam.CQ40.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_pfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_pfam_LocalAlignmentMode.txt";
	string scoreMode = "LOCAL_ALIGNMENT_MODE";
...
// pfam_short files & GLOBAL_ALIGNMENT_MODE.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_pfamFiles_GAMode)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.pfam.CQ40.fasta";
	const char * inMasterReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/master.pfam.CQ40.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_pfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_pfam_GlobalAlignmentMode.txt";
	string scoreMode = "GLOBAL_ALIGNMENT_MODE";
...
// pfam_short files & LOCAL_ALIGNMENT_MODE & unclustered.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_pfamFiles_LAMode_unclustered)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.pfam.CQ40.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_pfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_pfam_LocalAlignmentMode_unclustered.txt";
	string scoreMode = "LOCAL_ALIGNMENT_MODE";
...
// pfam_short files & COMMON_QGRAM_MODE.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_pfamFiles_CQMode)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.pfam.CQ40.fasta";
	const char * inMasterReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/master.pfam.CQ40.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_pfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_pfam_CommonQgramMode.txt";
	string scoreMode = "COMMON_QGRAM_MODE";
...
// pfam_short files & COMMON_QGRAM_MODE.
SEQAN_DEFINE_TEST(test_GSearch_systemTest_pfamFiles_CQMode_unclustered)
{
	const char * inClustDataBaseReferencePath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/clustered.pfam.CQ40.fasta";
	const char * inQueriesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/unmutable/queries_pfam.short.fasta";
	const char * outMatchesPath = "../../seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/mutable/matches_pfam_CommonQgramMode.txt";
