...
int main(int argc, char const ** argv) {
	...
	GSearch(matchesSoll, dataBaseLength, performance_uncl, inDataBasePath, "", inQueriesPath, matchFile_uncl, 300, scoreMode);
	...
	for (int i=0; i<length(clustDatabases)-1;++i){
		...
		GSearch(matchesIs, dataBaseLength, performance, clustDatabases[i], masterSequenceFiles[i], inQueriesPath, matchFiles[i], 300, scoreMode);
	...
	GSearch(matchesSoll2, dataBaseLength2, performance_uncl2, inDataBasePath2, "", inQueriesPath2, matchFile_uncl2, 300, scoreMode);
	...
	for (int i=0; i<length(clustDatabases2)-1;++i){
		...
		GSearch(matchesIs2, dataBaseLength2, performance2, clustDatabases2[i], masterSequenceFiles2[i], inQueriesPath2, matchFiles2[i], 300, scoreMode);
