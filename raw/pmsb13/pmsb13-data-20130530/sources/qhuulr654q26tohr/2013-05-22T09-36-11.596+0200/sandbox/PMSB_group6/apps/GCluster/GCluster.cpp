...
int main(int argc, char const ** argv) {
    ...
    addSetMinValue(parser, "threshold", 0);
    addSetMinValue(parser, "threshold", 1000);
    addSetMinValue(parser, "clusterLengthThreshold", 0);
    addSetMinValue(parser, "clusterLengthThreshold", 1);
