...
int main(int argcm, char const ** argmv) {
	...
	const char * argv[6] = {"./bin/clusterSearch","/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/emptyTest/empty.fasta",outClustDataBasePath,outMasterPath,"-t","4"};
