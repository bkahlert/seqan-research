...
int main(int argc, char const ** argv) {
	...
	if (sequenceFormat=="DNA"){
		...
		int res = GCluster(performance, toCString(inPath), toCString(outPath), toCString(outMasterPath), sequenceFormatExample, threshold, lengthThreshold, toCString(scoreMode));
		if (res!=0) {
