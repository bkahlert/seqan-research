...
SEQAN_DEFINE_TEST(test_GPostProcessMatches_dummy1)
{
	String<GMatch<int, Rna5String> > unsortetResults;
...
SEQAN_DEFINE_TEST(test_GPostProcessMatches_alreadySorted)
{
	String<GMatch<int, Rna5String> > unsortetResults;
	resize(unsortetResults,5);
	unsortetResults[0].score=8;
	unsortetResults[1].score=7;
	unsortetResults[2].score=5;
	unsortetResults[3].score=3;
	unsortetResults[4].score=2;
	
	int res=GPostProcessMatches(unsortetResults);
	SEQAN_ASSERT_EQ(unsortetResults[0].score,8);
	SEQAN_ASSERT_EQ(unsortetResults[1].score,7);
	SEQAN_ASSERT_EQ(unsortetResults[2].score,5);
	SEQAN_ASSERT_EQ(unsortetResults[3].score,3);
	SEQAN_ASSERT_EQ(unsortetResults[4].score,2);
...
SEQAN_DEFINE_TEST(test_GPostProcessMatches_short1)
{
	String<GMatch<int, Rna5String> > unsortetResults;
	resize(unsortetResults,1);
	unsortetResults[0].score=7;
	
	int res=GPostProcessMatches(unsortetResults);
	SEQAN_ASSERT_EQ(unsortetResults[0].score,7);
	SEQAN_ASSERT_EQ(res,0);
	
}

SEQAN_DEFINE_TEST(test_GPostProcessMatches_short2)
{
	String<GMatch<int, Rna5String> > unsortetResults;
	resize(unsortetResults,2);
	unsortetResults[0].score=8;
	unsortetResults[1].score=17;
	
	int res=GPostProcessMatches(unsortetResults);
	SEQAN_ASSERT_EQ(unsortetResults[0].score,17);
	SEQAN_ASSERT_EQ(unsortetResults[1].score,8);
	SEQAN_ASSERT_EQ(res,0);
