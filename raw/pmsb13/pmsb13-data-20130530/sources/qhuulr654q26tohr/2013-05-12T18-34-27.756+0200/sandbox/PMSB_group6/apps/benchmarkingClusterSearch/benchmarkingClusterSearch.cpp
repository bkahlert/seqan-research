...
int main(int argc, char const ** argv) {
	...
	const char * argvGCluster1[] = {"./bin/GCluster",inDataBasePath,outClustDataBasePath1,outMasterPath1,"-t","850","-m",scoreMode1};
	const char * argvGSearch1[] = {"./bin/GSearch",outClustDataBasePath1,outMasterPath1,inQueriesPath,"-m",scoreMode1};
	...
	const char * argvGCluster2[] = {"./bin/GCluster",inDataBasePath,outClustDataBasePath2,outMasterPath2,"-t","850","-m",scoreMode2};
	const char * argvGSearch2[] = {"./bin/GSearch",outClustDataBasePath2,outMasterPath2,inQueriesPath,"-m",scoreMode2};
	...
	const char * argvGSearch3[] = {"./bin/GSearch",outClustDataBasePath3,outMasterPath3,inQueriesPath,"-m",scoreMode3};
