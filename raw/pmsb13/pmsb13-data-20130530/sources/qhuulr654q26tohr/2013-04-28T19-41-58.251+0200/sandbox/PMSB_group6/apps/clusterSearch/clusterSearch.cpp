...
int main(int argc, char const ** argv) {
	...
	const char * argv[6] = {"clusterSearch","/home/development/seqan-trunk/sandbox/PMSB_group6/tests/autoTestData/emptyTest/empty.fasta",outClustDataBasePath,outMasterPath,"-t","4"};
