...
seqan::String<seqan::Simple> compact_stellar(seqan::String<seqan::Dna> &seqOne, seqan::String<seqan::Dna> &seqTwo,
												seqan::CharString idOne,
												LaganOptions &options, )
{
	...
	seqan::SeedSet<seqan::Seed<seqan::Simple> > seedSet;
...
int main(int argc, char const ** argv){
	...
	seqan::String<seqan::Simple> seedChain;
