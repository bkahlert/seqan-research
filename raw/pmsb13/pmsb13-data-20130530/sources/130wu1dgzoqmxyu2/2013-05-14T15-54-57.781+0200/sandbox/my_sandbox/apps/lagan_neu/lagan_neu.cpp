...
int main(int argc, char const ** argv){
	...
	unsigned tempQ = options.q;
	unsigned intervall = 3;
	//debugging:
	...
	{
		std::cout << std::endl << "tempQ = " << tempQ << std::endl << std::endl;
		...
		if(!insert_seeds_in_seedChain(seedChain, startPos, endPos, seqOne, seqTwo, tempQ))
		{
