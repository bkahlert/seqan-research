...
bool get_global_seed_chain(	seqan::String<Seed<Simple> > &seedChain, seqan::DnaString &seq1, seqan::DnaString &seq2,
								std::pair<unsigned, unsigned> startPos, std::pair<unsigned, unsigned> endPos, unsigned q){
...
int main(int argc, char const ** argv){
	...
	*/
	...
	for(unsigned i = 0; i < startPos.size(); ++i){
		...
		if (get_global_seed_chain(tempChain, seqOne, seqTwo, q)){
