...
int main(int argc, char const ** argv){
	...
	typedef Finder<DnaString, Swift<SwiftLocal> > TFinder;
	    TFinder swiftFinder(idOne, minRepeatLength, maxRepeatPeriod);

	stellar(TFinder, qgramIndex, epsilon, minLength, xDrop,
			    50, 500, 50, 0, idOne, true,
				matches, AllLocal());
