...
int main(int argc, char const ** argv){
	...
	*/
	...
	DnaString window1 = infix(seqOne, beginPositionH(seedChain[0]), endPositionH(seedChain[0]));
	DnaString window2 = infix(seqTwo, beginPositionV(seedChain[0]), endPositionV(seedChain[0]));
