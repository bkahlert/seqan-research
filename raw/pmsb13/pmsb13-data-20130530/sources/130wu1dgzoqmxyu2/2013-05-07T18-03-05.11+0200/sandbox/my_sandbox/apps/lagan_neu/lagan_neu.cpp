...
int main(int argc, char const ** argv){
	...
	if (options.stellarKmer >= std::floor(1 / options.epsilon)){
	...
	std::cout << std::endl << argc << std::endl << "STELLAR: searching for seeds..." << std::endl;
	...
	*/
	std::cout << "STELLAR: done." << std::endl;
