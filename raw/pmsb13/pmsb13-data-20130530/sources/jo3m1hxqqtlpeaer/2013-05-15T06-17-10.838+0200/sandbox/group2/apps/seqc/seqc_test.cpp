...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ...
    SEQAN_ASSERT(seqan::find(dupFinder, "AAGGA"));
   
    seqan::clear(dupFinder);
    SEQAN_ASSERT_MSG(seqan::find(dupFinder, "TTTTT"), "pattern TTTTT should not have been found");
    
    seqan::clear(dupFinder);
    SEQAN_ASSERT(seqan::find(dupFinder, "AAAGA"));
