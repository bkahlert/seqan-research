...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ReadStats stats(5);
    stats.collectForDuplicationCheck((seqan::Dna5String)"AAAAA");
    stats.collectForDuplicationCheck((seqan::Dna5String)"CAAAA");
    stats.collectForDuplicationCheck((seqan::Dna5String)"GAAAA");
    stats.collectForDuplicationCheck((seqan::Dna5String)"AAAAC");
    stats.collectForDuplicationCheck((seqan::Dna5String)"AAAAG");
    stats.collectForDuplicationCheck((seqan::Dna5String)"AAAAT");
    stats.collectForDuplicationCheck((seqan::Dna5String)"AATAA");
    stats.collectForDuplicationCheck((seqan::Dna5String)"CAAAA");
