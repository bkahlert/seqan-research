...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ...
    SEQAN_ASSERT_EQ(1,seqan::length(seqan::find(dupFinder, "AAGGA")));
    SEQAN_ASSERT_EQ(0,seqan::length(seqan::find(dupFinder, "TTTTT")));
    SEQAN_ASSERT_EQ(2,seqan::length(seqan::find(dupFinder, "AAAGA")));
