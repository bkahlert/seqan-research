...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ...
    SEQAN_ASSERT_MSG(seqan::find(dupFinder, "AAGGA"), "should have been found");
   
    seqan::clear(dupFinder);
    SEQAN_ASSERT_MSG(!seqan::find(dupFinder, "TTTTT"), "should NOT have been found");
    
    seqan::clear(dupFinder);
    SEQAN_ASSERT_MSG(seqan::find(dupFinder, "AAAGA"), "should have been found");
