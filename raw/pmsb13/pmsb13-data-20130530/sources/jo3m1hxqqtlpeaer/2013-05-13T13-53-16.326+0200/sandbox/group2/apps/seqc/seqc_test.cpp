...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ReadStats stats(5);
    stats.collectForDuplicationCheck("AAAAA");
    stats.collectForDuplicationCheck("CAAAA");
    stats.collectForDuplicationCheck("GAAAA");
    stats.collectForDuplicationCheck("AAAAC");
    stats.collectForDuplicationCheck("AAAAG");
    stats.collectForDuplicationCheck("AAAAT");
    stats.collectForDuplicationCheck("AATAA");
    stats.collectForDuplicationCheck("CAAAA");
