...
SEQAN_DEFINE_TEST(test_kmer_content){
    ...
    SEQAN_ASSERT_EQ(kc.kmerPositions[0]["AC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[3]["AC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[5]["AC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[0]["ACC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[5]["ACC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[3]["ACG"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[0]["AT"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[3]["AT"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[6]["AT"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[3]["ATA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[0]["ATC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[6]["ATC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[2]["CA"],2);
    SEQAN_ASSERT_EQ(kc.kmerPositions[7]["CA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[2]["CAC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[2]["CAT"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[1]["CC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[6]["CC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[1]["CCA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[6]["CCA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[4]["CG"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[4]["CGA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[5]["GA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[5]["GAT"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[4]["TA"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[4]["TAC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[1]["TC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[7]["TC"],1);
    SEQAN_ASSERT_EQ(kc.kmerPositions[1]["TCA"],1);
