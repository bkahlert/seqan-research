...
struct ReadStats{
    ...
    /**
     * collect quantiles information from cumulated intervals.
     * cum_intervals - list of unsig 
     *
     */
    void ReadStats::collectQuantiles(seqan::String<unsigned> & cum_intervals, seqan::String<char> & quantiles);
