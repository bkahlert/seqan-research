...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ...
    SEQAN_ASSERT_EQ(1,length(seqan::find(dupFinder, "AAGGA")));
    SEQAN_ASSERT_EQ(0,length(seqan::find(dupFinder, "AAAAA")));
    SEQAN_ASSERT_EQ(2,length(seqan::find(dupFinder, "AAAGA")));
