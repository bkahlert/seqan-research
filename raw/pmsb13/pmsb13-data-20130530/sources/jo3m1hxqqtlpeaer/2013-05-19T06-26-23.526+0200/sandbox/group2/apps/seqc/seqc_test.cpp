...
SEQAN_DEFINE_TEST(test_output_guess_scoreinfo_mixed){

    ReadStats stats(9);
    char lowS = 33; char highS = 57; // > Sanger, Illimuna 1.8+
    char lowX = 59; char highX = 92; // > Solexa
    char lowI = 64; char highI = 99; // > Illumina 1.3+, Illumina 1.5+
    char lowL = 34; char highL = 73; // > Illimuna 1.8+
...
SEQAN_BEGIN_TESTSUITE(test_seqc_stats)
{
    ...
    SEQAN_CALL_TEST(test_output_guess_scoreinfo_mixed);
