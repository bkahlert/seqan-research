...
/**
 * Everything we need to know about the scoring system used
 */
struct ScoreInfo{
...
struct ReadStats{
     ...
     * position in read 
     */
    seqan::String<seqan::String <__uint64> > scoreCount;
     ...
     * position in read
     */
    seqan::String<seqan::String <__uint64> > nucCount;
     ...
     *
     */
    seqan::String<__uint64> gcPerReadCount;
     ...
     *
     */
    seqan::String<__uint64> perReadQualCount;
     ...
     */
    std::map <unsigned,int> readLenCount;
    ...
    /**
     * This collects duplicates (only when they've found more than once) 
     */
    std::map <seqan::Dna5String,unsigned> duplicates;
    ...
    void collectQuantiles(seqan::String<__uint64> & cum_intervals, seqan::String<char> & quantiles, unsigned points);

    /**
     * method that accepts reads and queues them for duplication stats
     */
    void dupCheck(seqan::Dna5String const & seq);
