...
unsigned i=0;
    ...
    for(countIter=kmer.kmerCount.begin();countIter != (kmer.kmerCount.begin())&&i<6; ++countIter,++i){
	...
	unsigned j=0;
        for(countIter=kmer.kmerCount.begin();countIter != (kmer.kmerCount.begin())&&j<6; ++countIter,++j){
