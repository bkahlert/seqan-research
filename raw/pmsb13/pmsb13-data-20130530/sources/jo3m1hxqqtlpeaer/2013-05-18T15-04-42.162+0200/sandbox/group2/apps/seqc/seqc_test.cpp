 ...
 */
    ...
    stats.scoreCount[30][lowS] = 189;
    stats.scoreCount[20][highS] = 811;
    ...
    SEQAN_ASSERT_EQ(score_info.description, "no clue what this is");
    SEQAN_ASSERT_EQ(score_info.minScore, 33);
    SEQAN_ASSERT_EQ(score_info.maxScore, 33);
