...
SEQAN_DEFINE_TEST(test_stats_grow_with_dupcheck){
    ...
    SEQAN_ASSERT_EQ(true,seqan::length(seqan::find(dupFinder, "AAGGA")));
    SEQAN_ASSERT_EQ(false,seqan::length(seqan::find(dupFinder, "TTTTT")));
    SEQAN_ASSERT_EQ(true,seqan::length(seqan::find(dupFinder, "AAAGA")));
