...
SEQAN_DEFINE_TEST(test_collect_gc_per_read_dist){
    ...
    SEQAN_ASSERT_EQ(0, stats.gcPerReadCount[8]);

    seqan::CharString id = "";
    SEQAN_ASSERT_EQ(9,length(stats.gcPerReadCount));
    stats.collectReadStats(id, "AAAAA", "aaaaa");
    ...
    stats.collectReadStats(id, "GCGCCCCCC", "aaaaa");
    
    SEQAN_ASSERT_EQ(1, stats.gcPerReadCount[0]);
    SEQAN_ASSERT_EQ(2, stats.gcPerReadCount[1]);
    SEQAN_ASSERT_EQ(1, stats.gcPerReadCount[8]);
    
    SEQAN_ASSERT_EQ("gotten here", "had to stop");
} 

SEQAN_DEFINE_TEST(test_output_gc_per_read_dist){
    ReadStats stats(9);
