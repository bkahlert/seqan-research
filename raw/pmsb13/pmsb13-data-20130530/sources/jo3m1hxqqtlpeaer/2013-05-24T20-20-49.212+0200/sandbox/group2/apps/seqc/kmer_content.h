...
struct KmerContent{
     ...
     * kmer string as keys 
     */
    std::map<std::string,unsigned> kmerCount;
     ...
     * kmer string as keys 
     */
    std::map<unsigned,std::map<std::string,unsigned> > kmerPositions;

    /**
    *error variable default false
    *becomes true if kmer is longer than sequence length
    */
    bool error;
