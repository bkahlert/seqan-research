...
std::stringstream & TSVWriter::writeReadLength(ReadStats & stats, std::stringstream & ss)
{    
    // write out stats
...
std::stringstream & TSVWriter::writePerPosQual(ReadStats & stats, std:stringstream & ss)
{
