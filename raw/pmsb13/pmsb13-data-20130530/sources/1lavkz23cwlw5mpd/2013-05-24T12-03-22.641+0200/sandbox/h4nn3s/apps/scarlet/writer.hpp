...
//         if (lm.qryStart - m.qryStart != 0)
//         {
//             row0._array[1] += lm.qryStart - m.qryStart;
//             append(newseq0, infix(value(qrySeqs, m.qryId),
//                                     lm.qryStart,
//                                     m.qryStart));
//         }
//         append(newseq0, value(row0._source));
//         if (lm.qryEnd - mc.qryEnd != 0)
//         {
//             row0._array[((length(row0._array)-1) % 2 == 1)
//                             ? (length(row0._array)-1)
//                             : (length(row0._array)-2)] += m.qryEnd - lm.qryEnd;
//             append(newseq0, infix(value(qrySeqs, m.qryId),
//                                     m.qryEnd,
//                                     lm.qryEnd));
//         }
...
//         if (lm.subjStart - m.subjStart > 0 )
//         {
//             if (row1._array[0] != 0) // == (isGap(row1, 0))
//             {
//                 insertValue(row1._array, 0, lm.subjStart - m.subjStart);
//                 insertValue(row1._array, 0, 0);
//             }
//             else
//             {
//                 row1._array[1] += lm.subjStart - m.subjStart;
//             }
...
//         if (lm.subjEnd - m.subjEnd)
//         {
//             if (isGap(row1, length(row1)-1))
//                 appendValue(row1._array, m.subjEnd - lm.subjEnd);
//             else
//                 row1._array[length(row1._array)-1] += m.subjEnd - lm.subjEnd;
// 
//             append(newseq1, infix(value(subjSeqs, m.subjId),
//                                     m.subjEnd,
//                                     lm.subjEnd));
