#!/usr/bin/env python
"""Execute the tests for the masai_h2 program.
...
def main(source_base, binary_base):
    ...
    print 'Executing test for masai_h2'
    print '==========================='
    print
    
    ph = app_tests.TestPathHelper(
        source_base, binary_base,
        'extras/apps/masai_h2/tests')  # tests dir
    ...
    path_to_indexer = app_tests.autolocateBinary(
      binary_base, 'bin', 'masai_h2_indexer')

    path_to_mapper = app_tests.autolocateBinary(
      binary_base, 'bin', 'masai_h2_mapper')
