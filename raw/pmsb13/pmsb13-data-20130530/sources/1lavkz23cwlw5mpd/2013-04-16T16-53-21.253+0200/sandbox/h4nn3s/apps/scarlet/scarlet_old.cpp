...
parseCommandLine(AppOptions & options, int argc, char const ** argv)
{
    ...
    addOption(parser, seqan::ArgParseOption("a",
                                            "alph",
                                            "alphabet type of database sequences (auto/a, nucl/n, prot/p)",
    ...
    if (seqan::hasValue(parser, "output")
        seqan::getOptionValue(options.indexFile, parser, "output");
    else
        options.indexFile = options.dbFile + ".sa";
