...
int writeSeqs(CharString path, const StringSet<CharString>& ids, const StringSet<Dna5String>& seqs, const StringSet<CharString>& quals)
{
	...
	if(writeRecord(seqStream, ids, seqs, quals) != 0)		
	{
...
int main(int argc, char const * argv[])
{
	...
	CharString path = "c:/seqan/output/testgruppe.fastq";
	
	writeSeqs(path, ids, seqs, quals);
