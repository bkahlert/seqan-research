...
int loadAdapters(char const * path, StringSet<String<char> >& adids, StringSet<String<Dna5Q> >& ads)
{
...
int writeSeqs(char const * path, const StringSet<String<char> >& ids, const StringSet<String<Dna5Q> >& seqs)
{
