...
int main(int argc, char const ** argv)
{
    ...
    typedef typename Index<TSequence, IndexQGram<UngappedShape<8> > > TQIndex;
    typedef typename Finder<TQIndex, Swift<SwiftLocal> > TFinder;
    typedef typename Pattern<TQIndex, Swift<SwiftLocal> > TPattern;
