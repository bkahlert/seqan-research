...
int main(int argc, char const ** argv)
{
	...
	while (find(finder, pattern, errorRate, minimalLength)) {
	    ...
	    Seed<Simple> seed(beginPosition(infix1)+clippedBeginPosition(row(align,0)),beginPosition(infix1)+ clippedEndPosition(row(align,0)),
		    beginPosition(infix2)+clippedBeginPosition(row(align,1)),beginPosition(infix2)+ clippedEndPosition(row(align,1)));
