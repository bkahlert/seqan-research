...
int main(int argc, char const ** argv)
{
	...
	typedef Index<StringSet<TSequence>, IndexQGram<Shape<Dna5, UngappedShape<qGramLength> >, OpenAddressing> > TIndex;
	typedef Finder<TIndex, Swift<SwiftLocal> > TFinder;
