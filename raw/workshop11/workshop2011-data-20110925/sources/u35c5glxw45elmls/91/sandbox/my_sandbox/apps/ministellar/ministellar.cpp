...
//        std::cout << "Score:" << scr <<std::endl;
	...
	// HINT: Have a look at the Seed-and-Extend tutorial.
        ...
        if (getSeedSize(seed) < minimalLength) {
            continue;
        }
        ...
        outFile << "Local Alignment:" 
                << beginPosition(subseq1) + clippedBeginPosition(row(gAln, 0)) << " "
                << beginPosition(subseq2) + clippedBeginPosition(row(gAln, 1)) << " "
                << beginPosition(subseq1) + clippedEndPosition(row(gAln, 0))  << " "
                << beginPosition(subseq2) + clippedEndPosition(row(gAln, 1)) << " "
                << std::endl;
