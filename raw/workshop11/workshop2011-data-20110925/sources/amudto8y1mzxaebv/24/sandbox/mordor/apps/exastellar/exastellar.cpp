...
writeSeed(TSeed & seed, TSeq const & seq0, TSeq const & seq1) {
    std::cout << "Seed from position " << getBeginDim0(seed);
    std::cout << " to " << getEndDim0(seed) << ": ";
    std::cout << infix(seq0, getBeginDim0(seed), getEndDim0(seed) +1) << std::endl;
    std::cout << "Seed from position " << getBeginDim1(seed);
    std::cout << " to " << getEndDim1(seed) << ": ";
    std::cout << infix(seq1, getBeginDim1(seed), getEndDim1(seed)+1) << std::endl;
}
